...
import 'package:doctor_finder/pages/all_drugs.dart';
...
class DrugHome extends StatefulWidget {
  final int selectedIndex;
  DrugHome({this.selectedIndex});
  @override
  _DrugHomeState createState() => _DrugHomeState();
}

enum _SelectedTab { home, drugs, notifications, menu }

class _DrugHomeState extends State<DrugHome> {
  var _selectedIndex;
  bool _loading = true;
  final List _pages = [
    DrugStore(),
                ...
                child: ListView(
                  ...
                  children: [
                    ...
                    ListTile(
                      ...
                      title: Text(
                        "${S.of(context).switch_to} DoctorFinder",
                        style: DynamicTheme.of(context)
                            .data
                            .textTheme
                            .bodyText2
    ...
    return Scaffold(
      bottomNavigationBar: SalomonBottomBar(
        ...
        items: [
          ...
          /// Likes
          SalomonBottomBarItem(
            icon: Icon(FlutterIcons.capsules_faw5s),
            title: Text(intlDelegate.drug),
            selectedColor: ThemeUtil.lightDarkColor(
              AppConstants.primaryColor,
              Colors.white,
              dynamicTheme.data.brightness,
